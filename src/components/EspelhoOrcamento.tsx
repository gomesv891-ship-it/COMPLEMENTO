  ...
  return (
    ...
    >
      ...
      <div className="p-5 space-y-4 bg-white">
        ...
        {/* Se houver desconto > 0: exibe Desconto Especial Aplicado e Subtotal */}
        {/* Se o desconto for zero: oculta completamente ambos sem deixar espaços */}
        {/* ======================================================== */}
        {hasDesconto && (
          <div className="flex items-stretch gap-3 sm:gap-4">
            {/* Card de DESCONTO ESPECIAL APLICADO */}
            <div className="flex-1 rounded-xl overflow-hidden border border-emerald-200 bg-emerald-50/90 py-3 px-5 flex items-center justify-between shadow-2xs">
              <div className="flex items-center gap-2.5 text-emerald-800 font-black text-[13px] sm:text-[14px] uppercase tracking-wider">
                <Tag className="w-5 h-5 text-emerald-700 stroke-[2] flex-shrink-0" />
                <span>DESCONTO ESPECIAL APLICADO</span>
              </div>
              <div className="text-[16px] sm:text-[17px] font-black text-emerald-800">
                - {formatMoney(descontoValor)}
              </div>
            </div>

            {/* Card de SUBTOTAL */}
            <div className="w-[300px] flex-shrink-0 rounded-xl overflow-hidden border border-[#cde2f0] bg-[#f0f7fb] py-3 px-5 flex items-center justify-between shadow-2xs">
              <span className="text-[13px] sm:text-[14px] font-black tracking-wider text-[#004f8c] uppercase">
                SUBTOTAL
              </span>
              <span className="text-[16px] sm:text-[17px] font-black text-[#003865]">
        ...
        {/* ======================================================== */}
        {/* 4. FRETE & VALOR FINAL EM DESTAQUE                       */}
        {/* ======================================================== */}
        <div className="rounded-xl overflow-hidden border border-[#cde2f0] flex items-stretch bg-white shadow-2xs">
          {/* Lado Esquerdo: FRETE */}
          <div className="flex-1 bg-[#f0f7fb] py-3.5 px-5 flex items-center gap-4">
            <Truck className="w-8 h-8 text-[#004f8c] stroke-[1.8] flex-shrink-0" />
            <span className="text-[15px] font-black tracking-wider text-[#004f8c] uppercase">
              FRETE
            </span>

            {/* Linha Divisória Azul */}
            <div className="h-8 w-[1.5px] bg-[#004f8c]/25 flex-shrink-0" />
          ...
          <div className="w-[300px] bg-[#003865] text-white py-3.5 px-6 flex items-center justify-between flex-shrink-0">
            <span className="text-[13px] sm:text-[14px] font-black tracking-wider uppercase text-sky-100">
              TOTAL
            </span>
            <span className="text-[24px] sm:text-[26px] font-black tracking-tight text-white leading-none">
