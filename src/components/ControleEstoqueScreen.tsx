...
export function ControleEstoqueScreen({
  ...
  // SOMENTE 3 ABAS: 'produtos' | 'movimentacoes' | 'resumo'
  const [activeTab, setActiveTab] = useState<'produtos' | 'movimentacoes' | 'resumo'>('produtos');
  ...
  return (
    <div className="w-full px-4 sm:px-7 lg:px-9 xl:px-10 py-6 sm:py-8 space-y-7 sm:space-y-8 pb-20 text-slate-800 font-sans">
      ...
      {/* SOMENTE 3 ABAS DE NAVEGAÇÃO: Produtos em Estoque | Movimentações | Resumo */}
      ...
      {/* CONTEÚDO DA ABA 2: MOVIMENTAÇÕES */}
      {activeTab === 'movimentacoes' && (
